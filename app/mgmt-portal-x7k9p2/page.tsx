  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
      ...
      <div className="container mx-auto px-3 sm:px-6 py-3 sm:py-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
          <Link href="/mgmt-portal-x7k9p2/banks" className="bg-indigo-600 hover:bg-indigo-700 rounded-lg p-4 text-white transition-all group">
            <div className="flex items-center gap-3 sm:flex-col sm:items-start sm:gap-2">
              <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <h3 className="font-bold text-sm sm:text-base">Bank Accounts</h3>
                <p className="text-indigo-100 text-xs opacity-80">Manage deposit bank accounts</p>
              </div>
            </div>
          </Link>

          <Link href="/mgmt-portal-x7k9p2/rooms" className="bg-teal-600 hover:bg-teal-700 rounded-lg p-4 text-white transition-all group">
            <div className="flex items-center gap-3 sm:flex-col sm:items-start sm:gap-2">
              <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <h3 className="font-bold text-sm sm:text-base">Rooms</h3>
                <p className="text-teal-100 text-xs opacity-80">Manage game rooms</p>
              </div>
            </div>
          </Link>
          ...
          <Link href="/mgmt-portal-x7k9p2/settings" className="bg-gray-600 hover:bg-gray-700 rounded-lg p-4 text-white transition-all group">
            <div className="flex items-center gap-3 sm:flex-col sm:items-start sm:gap-2">
              ...
              <div>
                <h3 className="font-bold text-sm sm:text-base">Settings</h3>
                <p className="text-gray-100 text-xs opacity-80">System configuration</p>
              </div>
            </div>
          </Link>
        </div>
